...
using DinossauroCorrante.Graphics;

namespace DinossauroCorrante.Entities
{
    public class Estrela : SkyObject
    {
        ...
        public Estrela(IDayNightCycle dayNightCycle, Texture2D spriteSheet, Trex trex, Vector2 position) : base(trex, position)
        {
