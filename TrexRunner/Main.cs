...
using DinossauroCorrante.Entities;
using DinossauroCorrante.System;
using DinossauroCorrante.Extensions;
using System.IO;
...
namespace DinossauroCorrante
{
    ...
    public class Main : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            music_list = Content.Load<Song>(@"16Bit Rules of Nature");
            MediaPlayer.Volume = 0.10f;
            MediaPlayer.Play(music_list);
        }
